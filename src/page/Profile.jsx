...
const Profile = () => {
  return (
    <div className="max-w-sm mx-auto bg-gray-100 min-h-screen p-2 text-sm">
      {/* Header */}
      ...
      {/* Logout */}
      <div className="mt-6">
        <button className="flex items-center gap-2 text-red-500 text-sm font-medium px-4 py-3 w-full bg-white rounded-md shadow-sm">
          <BiLogOut />
          Logout
        </button>
      </div>
